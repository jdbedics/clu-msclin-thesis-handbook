...
\includegraphics[width=4.03in]{images/osf}
...
\hypertarget{formatting---overview}{%
\chapter{Formatting - Overview}\label{formatting---overview}}
...
\section{1. Title Page}\label{title-page}}
...
\section{2. Signature Page}\label{signature-page}}
...
\section{3. Dedication (optional)}\label{dedication-optional}}
...
\section{4. Acknowledgements (optional)}\label{acknowledgements-optional}}
...
\section{5. Table of Contents}\label{table-of-contents}}

\includegraphics[width=14.58in]{images/tablecontents}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{apa-sections-of-the-paper}{%
\section{APA Sections of the Paper}\label{apa-sections-of-the-paper}}
...
\includegraphics[width=4.31in]{images/thesiscommons}

...
\hypertarget{goal}{%
\chapter{Goal of the Handbook}\label{goal}}
...
\item
  Transparent and open sharing of materials and results via pre-registration and use of the open science framework.
\end{enumerate}
